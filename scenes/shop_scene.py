...
def cargar_icono(categoria):
    ...
    # los custom usan la imagen que este elegida
    if categoria == "background":
        imagen = pygame.image.load(customization.obtener_asset("background")).convert_alpha()
        return pygame.transform.scale(imagen, (55, 42))

    elif categoria == "bug":
        imagen = pygame.image.load(customization.obtener_asset("bug")).convert_alpha()
        return pygame.transform.scale(imagen, (48, 48))

    elif categoria == "bullet":
        imagen = pygame.image.load(customization.obtener_asset("bullet")).convert_alpha()
        return pygame.transform.scale(imagen, (55, 28))

    elif categoria == "vida":
        imagen = pygame.image.load("assets/heart.png").convert_alpha()
        return pygame.transform.scale(imagen, (46, 46))

    elif categoria == "municion":
        imagen = pygame.image.load("assets/bullet.png").convert_alpha()
        return pygame.transform.scale(imagen, (55, 28))

    elif categoria == "recarga":
        imagen = pygame.image.load("assets/jorge_reload.png").convert_alpha()
        return pygame.transform.scale(imagen, (48, 48))

    elif categoria == "penetracion":
        imagen = pygame.image.load("assets/bullet_rapid_fire.png").convert_alpha()
        return pygame.transform.scale(imagen, (55, 28))
...
def gameloop(screen, coins):
    ...
    font_categoria = pygame.font.Font(None, 31)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_RETURN:
                    ...
                    if categoria in ["vida", "municion", "recarga", "penetracion", "dano"]:
        ...
        # titulos
        texto_custom = font_chica.render("CUSTOMIZABLES", True, (170, 170, 170))
        screen.blit(texto_custom, (60, 105))

        texto_stats = font_chica.render("MEJORAS", True, (170, 170, 170))
        screen.blit(texto_stats, (60, 315))
        ...
        for i in range(len(categorias)):
            ...
            icono_rect = icono.get_rect(center=caja.center)

            screen.blit(icono, icono_rect)
        ...
        # fondo panel preview
        panel = pygame.Rect(555, 135, 390, 500)

        pygame.draw.rect(screen, (20, 20, 25, 190), panel, border_radius=18)
        ...
        if categoria in ["background", "bug", "bullet"]:
            ...
            screen.blit(
                variante,
                variante.get_rect(center=(750, 510))
            )
        ...
        # -----------------------------------------
            ...
            # imagen grande de la mejora
            icono_grande = cargar_icono(categoria)

            if categoria in ["vida", "recarga", "dano"]:
            ...
            screen.blit(
                icono_grande,
                icono_grande.get_rect(center=(750, 250))
            )
            ...
            screen.blit(
                nombre,
                nombre.get_rect(center=(750, 340))
            )
            ...
            screen.blit(
                texto_nivel,
                texto_nivel.get_rect(center=(750, 385))
            )


            valor_actual = habilidades.texto_valor(categoria)
            ...
            screen.blit(
                actual,
                actual.get_rect(center=(750, 425))
            )
            ...
            if nivel >= nivel_max:
                ...
                screen.blit(
                    maximo,
                    maximo.get_rect(center=(750, 510))
                )
                ...
                screen.blit(
                    texto_siguiente,
                    texto_siguiente.get_rect(center=(750, 465))
                )
                ...
                screen.blit(
                    texto_precio,
                    texto_precio.get_rect(center=(750, 520))
                )
                ...
                screen.blit(
                    comprar,
                    comprar.get_rect(center=(750, 565))
                )
        ...
        screen.blit(
            controles,
            controles.get_rect(center=(screen.get_width() // 2, 720))
        )
