...
# sirve para que una flecha no le pegue 4 frames al mismo dragon
    ...
    while running:
        ...
        if not pausado:
            ...
            if dos_jugadores and not player2.caido:
                ...
                powerups_recogidos_2 = pygame.sprite.spritecollide(
                    player2,
                    powerups,
                    True
                )
            ...
            if dos_jugadores:
                ...
                if enemigos_tocando_2 and not player2.caido:
